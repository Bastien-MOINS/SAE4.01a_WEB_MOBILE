...
from .models import Aeroport, Vol, Terminal, get_all_terminaux, create_terminal, get_terminal_by_id, \
                    ...
                    delete_terminal, terminal_est_occupe_ou_reserve, get_all_aeroports, get_aeroport_by_id, \
                    create_aeroport, update_aeroport, delete_aeroport
from flask_restx import Resource, Namespace, fields
from datetime import datetime
from .app import app, db, api
from .api_models import aeroport_model, aeroport_input_model, terminal_model, terminal_input_model, vol_model, vol_input_model
